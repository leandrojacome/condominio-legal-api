    ...
    schemas: {
      ...
      Cobranca: {
        ...
        properties: {
          ...
          condominioId: { type: "string" },
          unidadeId: { type: "string" },
          responsavelId: { type: "string", nullable: true, description: "Legacy userId do responsável financeiro" },
          devedorId: { type: "string", nullable: true, description: "Vinculo.id do responsável financeiro/devedor" },
          devedor: { type: "object", nullable: true, additionalProperties: true },
          valor: { type: "number" },
          vencimento: { type: "string", format: "date" },
          status: { type: "string", enum: ["em_aberto", "em_atraso", "paga", "cancelada"] },
          descricao: { type: "string" },
        },
      },
      CriarCobranca: {
  ...
  paths: {
    ...
    "/api/v1/financeiro/condominios/{id}/cobrancas": {
      get: {
        ...
        parameters: [
          condominioIdParam,
          ...pageable,
          { name: "status", in: "query", schema: { type: "string", enum: ["em_aberto", "em_atraso", "paga", "cancelada"] } },
          { name: "unidadeId", in: "query", schema: { type: "string" } },
          { name: "devedorId", in: "query", schema: { type: "string" } },
        ],
    ...
    "/api/v1/financeiro/condominios/{id}/inadimplentes": {
      get: {
        ...
        parameters: [condominioIdParam, ...pageable, { name: "devedorId", in: "query", schema: { type: "string" } }],
